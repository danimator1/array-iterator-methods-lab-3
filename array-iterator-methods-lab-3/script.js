...
// const veryOldInventors = inventors.filter(inventor => inventor.year >= 1500 && inventor.year <= 1599);
...
// let isAdultPresent = devs.some(person => (new Date().getFullYear() - person.year) >= 18);
